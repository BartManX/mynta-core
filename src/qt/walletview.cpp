...
void WalletView::setMyntaGUI(MyntaGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? MyntaGUI::HD44_ENABLED : _walletModel->hdEnabled() ? MyntaGUI::HD_ENABLED : MyntaGUI::HD_DISABLED);
