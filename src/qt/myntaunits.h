...
#ifndef MYNTA_QT_MYNTAUNITS_H
#define MYNTA_QT_MYNTAUNITS_H
...
/** Mynta unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MyntaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MyntaUnits(QObject *parent);
...
typedef MyntaUnits::Unit MyntaUnit;

#endif // MYNTA_QT_MYNTAUNITS_H
