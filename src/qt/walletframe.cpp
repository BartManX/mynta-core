...
WalletFrame::WalletFrame(const PlatformStyle *_platformStyle, MyntaGUI *_gui) :
    QFrame(_gui),
    gui(_gui),
...
void WalletFrame::gotoDonatePage()
{
    QMap<QString, WalletView*>::const_iterator i;
    for (i = mapWalletViews.constBegin(); i != mapWalletViews.constEnd(); ++i)
        i.value()->gotoDonatePage();
}
