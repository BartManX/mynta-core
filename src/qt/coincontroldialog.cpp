...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    l2->setText(MyntaUnits::formatWithUnit(nDisplayUnit, nAmount));        // Amount
    ...
    l8->setText(MyntaUnits::formatWithUnit(nDisplayUnit, nChange));        // Change
    if (nPayFee > 0)
    {
...
void CoinControlDialog::updateView()
{
    ...
    for (const std::pair<QString, std::vector<COutput>>& coins : mapCoins) {
        ...
        for (const COutput& out : coins.second) {
            ...
            // amount
            itemOutput->setText(COLUMN_AMOUNT, MyntaUnits::format(nDisplayUnit, out.tx->tx->vout[out.i].nValue));
