...
#ifndef MYNTA_QT_MYNTAGUI_H
#define MYNTA_QT_MYNTAGUI_H
...
*/
class MyntaGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MyntaGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~MyntaGUI();
