...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(MyntaUnits::MYNTA),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(MyntaUnits::formatWithUnit(unit, balance, false, MyntaUnits::separatorAlways));
    ui->labelUnconfirmed->setText(MyntaUnits::formatWithUnit(unit, unconfirmedBalance, false, MyntaUnits::separatorAlways));
    ui->labelImmature->setText(MyntaUnits::formatWithUnit(unit, immatureBalance, false, MyntaUnits::separatorAlways));
    ui->labelTotal->setText(MyntaUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, MyntaUnits::separatorAlways));
    ui->labelWatchAvailable->setText(MyntaUnits::formatWithUnit(unit, watchOnlyBalance, false, MyntaUnits::separatorAlways));
    ui->labelWatchPending->setText(MyntaUnits::formatWithUnit(unit, watchUnconfBalance, false, MyntaUnits::separatorAlways));
    ui->labelWatchImmature->setText(MyntaUnits::formatWithUnit(unit, watchImmatureBalance, false, MyntaUnits::separatorAlways));
    ui->labelWatchTotal->setText(MyntaUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, MyntaUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("MYNTA")
    updateDisplayUnit();
}
