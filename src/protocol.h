...
// =======================================================================
// LLMQ (Long-Living Masternode Quorum) Messages
// =======================================================================

/**
 * A quorum signature share for signing session.
 * Masternode quorum members send these to participate in threshold signing.
 */
extern const char *QSIGSHARE;

/**
 * An InstantSend lock message.
 * Sent when a transaction's inputs are locked by a quorum.
 */
extern const char *ISLOCK;

/**
 * A ChainLock signature message.
 * Sent when a block hash is signed by a quorum.
 */
extern const char *CLSIG;

/**
 * Request for quorum verification data.
 * Used to verify quorum composition.
 */
extern const char *QGETDATA;

/**
 * Quorum data response.
 * Contains quorum member information for verification.
 */
