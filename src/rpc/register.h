...
/** Register quorum RPC commands */
void RegisterQuorumRPCCommands(CRPCTable &tableRPC);
/** Register BLS RPC commands */
void RegisterBLSRPCCommands(CRPCTable &tableRPC);
...
static inline void RegisterAllCoreRPCCommands(CRPCTable &t)
{
    ...
    RegisterQuorumRPCCommands(t);
    RegisterBLSRPCCommands(t);
}
