...
$(package)_patches+= fix_gcc15_limits.patch
$(package)_patches+= fix_macos_libpng_fp.patch
...
$(package)_config_env_darwin = QT_MAC_SDK_NO_VERSION_CHECK=1
...
define $(package)_preprocess_cmds
  ...
  patch -p1 -i $($(package)_patch_dir)/fix_macos_libpng_fp.patch && \
